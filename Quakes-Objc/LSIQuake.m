...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    ...
    // All fields are required to initialize (assumption in this example)
    if (magnitude && place && timeNumber && latitude && longitude) {
        ...
        self = [self initWithMagnitude:magnitude.doubleValue place:place time:time latitude:latitude.doubleValue longitude:longitude.doubleValue];
